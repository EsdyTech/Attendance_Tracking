       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Contribution Level</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Add Contribution Level</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Contribution Level</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post" action="scripts/saveContributionLevel.php">
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="amount" id="exampleInputFirstName" placeholder="Amount">
                        </div>
                        <div class="col-xl-6">
                    ...
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                            <label class="form-control-label">Is Dividend?<span class="text-danger ml-2">*</span></label>
                      <select class="form-control mb-3"  name="isDividend">
