       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Assets Category</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Add Assets Category</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Assets Category</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post" action="scripts/saveAssestsCat.php">
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                            <label class="form-control-label">Name<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="catName" id="exampleInputFirstName" placeholder="Name">
                        </div>
                        <div class="col-xl-6">
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="description" id="exampleInputFirstName" placeholder="Description">
                        ...
                        <!-- <div class="col-xl-6">
                            <label class="form-control-label">Documents<span class="text-danger ml-2">*</span></label>
                      <input type="textarea" class="form-control"  name="description" id="exampleInputFirstName" placeholder="Description">
                        </div> -->
                    </div>
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">All Assets Category</h6>
                </div>
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT * FROM assetcategory WHERE coopId = ".$_SESSION['coopId']."";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      if($num > 0)
                      { 
